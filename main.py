...
<body>
  ...
  <script>
    ...
    const OTC_ASSETS = [
      "AED/CNY ОТС","BHD/CNY OTC","USD/BDT OTC","EUR/USD OTC","GBP/USD OTC","USD/JPY OTC","AUD/USD OTC","NZD/JPY OTC", "AUD/USD OTC","CAD/JPY OTC","EUR/CHF OTC","NZD/USD OTC","USD/CAD OTC","USD/JPY OTC","EUR/TRY OTC","USD/INR OTC",
    ];
